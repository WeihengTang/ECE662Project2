...
For the LDA baseline, we use sklearn's \texttt{LinearDiscriminantAnalysis},
...
($d_{\text{out}}\in\{32,64,96,128\}$; see the recorded sweep in
\texttt{cnn\_olt\_summary.json}), ruling out information loss as the
