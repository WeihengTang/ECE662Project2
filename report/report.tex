...
This holds even when we raise $d_{\text{out}}$ to $128$ (no dimension
reduction), ruling out information loss as the cause. The explanation
...
This negative result is itself informative: it highlights that the OLT
