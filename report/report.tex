...
accuracy of only $0.229$ and an ARI of $0.055$. This means the
pseudo-labels fed into the OLT training pipeline were overwhelmingly
noisy (over $77\%$ incorrect).
...
pseudo-labels, the OLT objective (specifically the nuclear norm) acts as
a powerful structural prior. By forcing the data into orthogonal
low-rank subspaces, OLT inherently filters out the unstructured noise
introduced by the flawed spectral initialization. Consequently, it
